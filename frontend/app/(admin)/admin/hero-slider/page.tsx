    ...
    <div>
      ...
      >
        <div className="flex h-full grow flex-col">
          <div className="flex flex-1 justify-center sm:p-2 md:p-2">
            <div className="flex w-full max-w-7xl flex-col">
              <div className="flex flex-wrap items-center justify-between gap-4 pb-8">
                ...
                <div className="flex gap-2">
                  ...
                  <button className="flex h-10 items-center justify-center gap-2 whitespace-nowrap rounded-lg bg-rose-gold hover:bg-pink-600 px-4 text-sm font-medium text-white">
                    Save Changes
                  </button>
                </div>
              </div>
